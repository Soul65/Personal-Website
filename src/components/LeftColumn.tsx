import { Box, Divider, Grid, Group, Image, Stack, Text, useMantineTheme } from '@mantine/core';
				...
				<SiteCard title='Education'>
					<Stack gap='4'>
						...
						<Box>
							...
							/>
							<p>
								At Resurrection Catholic Secondary School, I took computer
								programming in both grades 11 and 12. This is where I finally
								started to learn the basics of coding. We started by learning Turing
								and then Java the year after. I also went to the Skills Ontario
								Competition for both 2D and 3D animation. They were both really
								interesting to be in, but also made me realize I wasn't cut out for
								that sort of thing.
							</p>
						</Box>
						<Divider />
