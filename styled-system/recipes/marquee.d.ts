...
export type MarqueeVariantProps = {
  [key in keyof MarqueeVariant]?: ConditionalValue<MarqueeVariant[key]> | undefined
}
...
export interface MarqueeRecipe {
  ...
  splitVariantProps<Props extends MarqueeVariantProps>(props: Props): [MarqueeVariantProps, Pretty<DistributiveOmit<Props, keyof MarqueeVariantProps>>]
  getVariantProps: (props?: MarqueeVariantProps) => MarqueeVariantProps
}

/**
 * Styles for the Ticker component
 */
